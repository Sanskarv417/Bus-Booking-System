...
CREATE TABLE `bookings` (
  ...
  KEY `user_id` (`user_id`),
  KEY `bus_id` (`bus_id`),
  KEY `seat_number` (`seat_number`,`bus_id`),
  CONSTRAINT `bookings_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`),
  CONSTRAINT `bookings_ibfk_2` FOREIGN KEY (`bus_id`) REFERENCES `bus` (`id`),
  CONSTRAINT `bookings_ibfk_3` FOREIGN KEY (`seat_number`, `bus_id`) REFERENCES `seats` (`seat_number`, `bus_id`)
